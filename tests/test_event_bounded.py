...
1. Labeling — that the boundary is strict, that time- and event-bounded queries can coexist in
   one sequence, and that the degenerate "boundary never fires" case behaves as documented
